  ...
  return (
    <div>
      ...
      <div className="max-w-sm mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-none">
        ...
        {/* Pricing tab 1 */}
{/* Course Selling Tab 1 */}
<PricingTab
  yearly={isAnnual}
  planName="Kickstart to Cloud ☁️"
  price={{ yearly: 0, monthly: 0 }}
  planDescription="Join the FREE 2 Day's Weekend Bootcamp practicals Session's"
  features={[
    '5+ Live Practical\'s Implementation\'s',
    'Fresher to 10+ LPA job',
    'Any One Can Start Today...!',
  ]}
/>

{/* Course Selling Tab 2 */}
<PricingTab
  yearly={isAnnual}
  popular={true}
  planName="Time to play 🎉"
  price={{ yearly: 49, monthly: 55 }}
  planDescription="Join 30+ RealTime Practical\'s, 3 Week\'s Live Cloud Computing, Linux, AWS Top Services & DevOps implementation\'s."
  features={[
    '100% live interactive sessions',
    'Get 10 to 20+ LPA job',
    'Any Experience (Any Domain)',
  ]}
/>

{/* Course Selling Tab 3 */}
<PricingTab
  yearly={isAnnual}
  planName="Time to fly 🚀"
  price={{ yearly: 79, monthly: 85 }}
  planDescription="Join 2.5 Month\'s Multi-Cloud + DevOps Master\'s Program for highest package"
  features={[
    '100% Live Interactive Session\'s',
    'Get 15 to 45+ LPA',
    'Already in IT and want to Upskill',
  ]}
/>
