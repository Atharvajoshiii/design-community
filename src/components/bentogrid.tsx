          ...
          <div className="flex flex-col justify-between h-full">
            <div className="mb-4 px-6 mt-6">
              <div className="flex justify-between items-center mb-6 pb-2">
                <h2 className="text-white/70 text-xl">Students Data</h2>
            ...
            <div className="text-left p-6 mt-4">
              ...
              <p className="text-white/70 text-lg">Every year number of students joining in our batch just got increased</p>
            </div>
          </div>
        </CardWithEffect>
          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                <h1 className="text-white text-2xl font-bold mb-2">Learn Multiple Technologies</h1>
                <p className="text-white/70 text-lg">Learn the most advance technologies ! integrate in your projects and make large scale products</p>
              </div>
            </div>
          </CardWithEffect>
          <CardWithEffect>
